...
const visualIconTools = [
  ...
  { label: "Soal", token: "{{icon:soal:1}}" },
  { label: "fish", token: "{{icon:fish:1}}" },
  { label: "box", token: "{{icon:box:1}}" },
  { label: "cat", token: "{{icon:cat:1}}" },
  { label: "star", token: "{{icon:star:1}}" },
  { label: "banana", token: "{{icon:banana:1}}" },
  { label: "oranges", token: "{{icon:oranges:1}}" },
];
